    ...
    <div className="intro-content grid grid-cols-2 gap-5 h-full w-full">
        ...
        <div className="intro-left flex flex-col justify-center h-full pb-28">
            ...
            <p className="text-2xl font-normal text-[#666666] mt-5 leading-10">
                The best HR software for StickyHR companies and startups to manage employees, payroll assistance, time off, and attendance tracking with a single software.
            </p>
        ...
        <div className="intro-right relative flex justify-center items-center h-full">
            {/* Decorative Images */}
            <img src={img1} alt="Icon 1" className="absolute top-0 right-10 w-20 h-20 rotate-12" />
